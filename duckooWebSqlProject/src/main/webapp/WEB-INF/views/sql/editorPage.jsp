...
<div id="wrapper" style="width:100%; height:100%">
	...
	<div id="sideBar" style="float:left; width:15%; height:650px; background-color:#d2d2d2; border-radius: 5px;">
	 ...
	 <div style="width:100%; height:610px; border-radius: 5px; background-color: white;border-radius: 10px; border-style: groove;">
		...
		<form method="post" id="canvasDiv" style="float:left; width:83%; height:650px; border-bottom-style: groove; overflow:scroll;">
			<textarea rows="100" cols="100" name="sql" style="display:none">
			<dfn>js-graph-it</dfn>
			
			</textarea>
			<div id="viewMode" contentEditable="true" style="height:100%; width:100%;">
			<div><dfn>js-graph-it</dfn></div>
			</div>
...
<script>
	$(document).ready(function(e){
		function chkForm(){ 
		    if(document.getElementsByName("sql")[0].value.match(/흐미|옴마|select/)){ 
		        document.getElementsByName("sql")[0].style.color = "red"; 
		    } 
		} 
		chkForm();
	});
